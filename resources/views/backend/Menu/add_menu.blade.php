            ...
            <div class="panel-body">
                <form method="POST" action="add_menu_category">
                    ...
                    <div id="new_menu" class="form-group">
                        ...
                        <input type="text" name="food_category[][name]" parsley-trigger="change" required="" placeholder="Enter Category Name" autocomplete="off" class="form-control new-cat">
                        <input type="hidden" name="food_category[][order]">
                        </div>
                    </div>
...
<script>
    ...
    $('#addInput').click(function() {
        ...
        "<input type='text' name='food_category[][name]' parsley-trigger='change' placeholder='Enter Category Name' autocomplete='off' class='form-control new-cat' required>" +
        "<input type='hidden' name='food_category[][order]'>"+
