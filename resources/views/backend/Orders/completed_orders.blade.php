    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default panel-table">
                <div class="panel-heading">Completed Orders
                ...
                <div class="panel-body">
                    <div id="table1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                ...
                                <table id="table1" class="table table-striped table-hover table-fw-widget dataTable no-footer"
                                    ...
                                    <tbody>
                                        ...
                                        @if (Auth::check() && Auth::user()->acc_type == '1')
                                            @foreach ($completed_orders as $list)
                        ...
                        <div class="row be-datatable-footer">
                            <div class="col-sm-5">
                                <div class="dataTables_info" id="table1_info" role="status" aria-live="polite"><?php echo "Showing " . $completed_orders->firstItem() . " to " . $completed_orders->lastItem() . " of " . $completed_orders->total() . " entries"; ?></div>
                            </div>
                            <div class="col-sm-7">
                                <div class="dataTables_paginate paging_simple_numbers" id="table1_paginate">
                                    <?php echo $completed_orders->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
