        ...
        <div class="container-fluid">
          ...
          <div class="be-right-navbar">
            <ul class="nav navbar-nav navbar-right be-user-nav">
              ...
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="/assets/img/avatar.png" alt="Avatar"><span class="user-name">Foodway</span></a>
            ...
            <div class="page-title"><span>Foodway Delivery</span></div>
              ...
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><span class="icon mdi mdi-notifications"></span><span class="indicator"></span></a>
                <ul class="dropdown-menu be-notifications">
                  <li>
                    ...
                    <div class="list">
                      <div class="be-scroller ps-container ps-theme-default" data-ps-id="a98c2900-c524-b578-92d2-cb78fde72a4d">
                        <div class="content">
                          <ul>
